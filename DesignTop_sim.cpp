...
lb_p4_clamped_stencil_update_stream$mem_2$c1_out = 0001;
...
(state->lb_p4_clamped_stencil_update_stream$mem_2$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_p4_clamped_stencil_update_stream_wen_out ? MASK( 4, (lb_p4_clamped_stencil_update_stream$mem_2$waddr$reg0_out + lb_p4_clamped_stencil_update_stream$mem_2$c1_out) ) : lb_p4_clamped_stencil_update_stream$mem_2$waddr$reg0_out) : (state->lb_p4_clamped_stencil_update_stream$mem_2$waddr$reg0));
(state->lb_p4_clamped_stencil_update_stream$mem_2$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_p4_clamped_stencil_update_stream_wen_out ? MASK( 4, (lb_p4_clamped_stencil_update_stream$mem_2$raddr$reg0_out + lb_p4_clamped_stencil_update_stream$mem_2$c1_out) ) : lb_p4_clamped_stencil_update_stream$mem_2$raddr$reg0_out) : (state->lb_p4_clamped_stencil_update_stream$mem_2$raddr$reg0));
lb_p4_clamped_stencil_update_stream$mem_1$waddr$reg0_out = (state->lb_p4_clamped_stencil_update_stream$mem_1$waddr$reg0);
lb_p4_clamped_stencil_update_stream$mem_1$c1_out = 0001;
(state->lb_p4_clamped_stencil_update_stream$mem_1$waddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_p4_clamped_stencil_update_stream_wen_out ? MASK( 4, (lb_p4_clamped_stencil_update_stream$mem_1$waddr$reg0_out + lb_p4_clamped_stencil_update_stream$mem_1$c1_out) ) : lb_p4_clamped_stencil_update_stream$mem_1$waddr$reg0_out) : (state->lb_p4_clamped_stencil_update_stream$mem_1$waddr$reg0));
...
(state->lb_p4_clamped_stencil_update_stream$mem_1$raddr$reg0) = ((((state->self_clk_last) == 0) && ((state->self_clk) == 1)) ? (lb_p4_clamped_stencil_update_stream_wen_out ? MASK( 4, (lb_p4_clamped_stencil_update_stream$mem_1$raddr$reg0_out + lb_p4_clamped_stencil_update_stream$mem_1$c1_out) ) : lb_p4_clamped_stencil_update_stream$mem_1$raddr$reg0_out) : (state->lb_p4_clamped_stencil_update_stream$mem_1$raddr$reg0));
(state->self_out) = (((0000000000000000 + (lb_p4_clamped_stencil_update_stream$mem_2$mem_rdata * 0000000000000011)) + (lb_p4_clamped_stencil_update_stream$mem_1$mem_rdata * 0000000000000101)) + ((state->self_in_0) * 0000000000000111));
}
