...
void simulate_0( circuit_state* state ) {
  ...
  cout << "lb_p4_clamped_stencil_update_stream$mem_1$mem_rdata = " << lb_p4_clamped_stencil_update_stream$mem_1$mem_rdata << endl;

  cout << "state->self_in_0 = " << state->self_in_0 << endl;
